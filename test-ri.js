...
async function testRtoInfo(regNo) {
    try {
        console.log(`Testing rto-vehicle-information.com for ${regNo}...`);
        const url = `https://rto-vehicle-information.com/search?reg_no=${regNo}`;
        ...
        return { error: 'RTOInfo failed: ' + e.message };
    }
}
